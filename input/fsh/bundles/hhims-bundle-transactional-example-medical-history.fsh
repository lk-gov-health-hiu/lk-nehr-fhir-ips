Instance: HHIMSTransactionalBundleExampleWithMedicalHistory
InstanceOf: HHIMSTransactionalBundle
Usage: #example
Title: "HHIMS Transactional Bundle with medical history"
Description: "A full transactional bundle containing a medical history for the HHIMS patient."
* type = #transaction
...
* insert ExampleTransactionalEntry(MedicalHistoryExample, condition, Condition)
