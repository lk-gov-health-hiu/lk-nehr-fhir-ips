Instance: HHIMSIPSBundleExampleWithMedicalHistory
InstanceOf: HHIMSIPSBundle
Usage: #example
Title: "HHIMS IPS Bundle with medical history"
Description: "A full IPS derived bundle containing a medical history for the HHIMS patient."
* type = #document
...
* insert ExampleDocumentEntry(HHIMSCompositionExampleWithMedicalHistory, composition, Composition)
