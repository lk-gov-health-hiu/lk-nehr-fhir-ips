...
* entry[patient]
  * fullUrl 1..1
  * resource 1..
  * resource only HHIMSPatient

* entry[encounters]
  * fullUrl 1..1
  * resource 1..
  * resource only HHIMSTargetFacilityEncounter
...
* insert BundleEntry(HHIMSWeight, observation-weight, reason why this should be supported.)
* insert BundleEntry(HHIMSAllergies, allergyintolerance, reason why this should be supported.)
...
* insert BundleEntry(HHIMSMedicalHistory, condition, reason why this should be supported.)
