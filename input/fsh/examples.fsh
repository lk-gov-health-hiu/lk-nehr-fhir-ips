...
Usage: #example
Title: "Medication Request (Frequency is specified as a value)"
...
Instance: MedicationRequestsWithCodedFrequencyExample
InstanceOf: MedicationRequests
Usage: #example
Title: "Medication Request (Frequency is coded)"
Description: "This is to record requests for medication that are prescribed to a patient or for Non-MDS medicines."
* identifier[RequestID].value = "prescription-12345"
* identifier[RequestID].system = "http://fhir.health.gov.lk/ips/identifier/medication"
* identifier[RequestID].type.coding.code = #FILL
...
* dosageInstruction[=].timing.repeat.duration = 2.0
* dosageInstruction[=].timing.repeat.durationUnit = #d
* dosageInstruction[=].timing.code.coding.code = #LK-DF-04
* dosageInstruction[=].timing.code.coding.system = "http://fhir.health.gov.lk/ips/CodeSystem/cs-drug-frequency"
* dispenseRequest.quantity.value = 5
* note.text = "Additional information regarding the patient's medication prescription"
* note.authorReference = Reference(OrganizationExample)
* note.time = "2023-10-11T17:21:33-08:00"
...
Usage: #example
Title: "Medication Request - No Prescriptions"
...
Instance: HHIMSCompositionExampleNoMedicalHistory
InstanceOf: HHIMSComposition
Usage: #example
Title: "HHIMS Composition"
Description: "Clinical document used to represent the International Patient Summary (IPS) data set for a HHIMS patient with no medical history"
* identifier.value = "PAT0001-v1"
...
Instance: HHIMSCompositionExampleWithMedicalHistory
InstanceOf: HHIMSComposition
Usage: #example
Title: "HHIMS Composition"
Description: "Clinical document used to represent the International Patient Summary (IPS) data set for a HHIMS patient with a medical history"
* identifier.value = "PAT0001-v1"
* identifier.system = "http://fhir.health.gov.lk/ips/identifier/hhims-ips-document"
* status = #final
* subject = Reference(PatientExample)
...
Instance: MedicalHistoryListExample
InstanceOf: MedicalHistoryList
Usage: #example
...
* entry[CurrentMedicalInformation][+].item = Reference(MedicalHistoryExample)

* entry[PastMedicalHistory][+].item = Reference(NoMedicalHistoryExample)