...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.lk/ips/StructureDefinition/patient-registration-system']) &gt;= 1">extension with URL = 'http://fhir.health.gov.lk/ips/StructureDefinition/patient-registration-system': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.lk/ips/StructureDefinition/patient-registration-system']) &lt;= 1">extension with URL = 'http://fhir.health.gov.lk/ips/StructureDefinition/patient-registration-system': maximum cardinality of 'extension' is 1</sch:assert>
